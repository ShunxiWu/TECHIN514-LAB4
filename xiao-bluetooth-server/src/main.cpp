...
#define SERVICE_UUID "a2b321e6-a00e-41f1-a21c-32329f18a33d"
#define CHARACTERISTIC_UUID "c661b50c-aa6d-4e83-a0ba-19a288b155f5"
...
void setup()
{
  ...
  pCharacteristic->setValue("AxiLeo");
  pService->start();
